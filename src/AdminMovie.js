...
const AdminMovie = ({ movie, setMovie, onSearch, search }) => {
  ...
  const addMovie = () => {
    console.log(input);
    axios
      .post(`https://test-124ae-default-rtdb.firebaseio.com/posts.json`, input)
    ...
    <div className="dark-edition">
      <div class="wrapper ">
        ...
        <div class="main-panel">
          ...
          <div class="content">
            ...
            <div className="d-flex justify-content-around mt-5">
              <p className="countMovies">
                {" "}
                {Object.values(movie).length} Movies
              </p>
              <Button
                onClick={handleShow}
                className="btn-signIn addMovies"
                variant=""
              >
                Add movie
              </Button>
        ...
        el.Title.toLowerCase().includes(search.toLowerCase())
              ...
              {Object.keys(movie).map((cle) => (
                <Card
                  className="movie-card text-white m-2"
                  style={{ width: "16rem" }}
                >
                  <Card.Img src={movie[cle].Poster} alt="Card image" />
                  <div className="p-3 body-card">
                    <h6>{movie[cle].Title}</h6>
                    <h6>{movie[cle].Year}</h6>
                    <Rater
                      total={5}
                    ...
                    <div className="d-flex justify-content-around">
                      <Button onClick={() => deleteMovie(cle)}>
                        <i class="fas fa-trash-alt"></i>
                      </Button>

                      <UpdateModal cle={cle} movie={movie} />
                    </div>
                  </div>
                </Card>
              ))}
